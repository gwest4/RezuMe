...
/**
 * CandidateSignupResumeServlet.
 * 
 * @author Adrian Baran
 */
public class CandidateSignupResumeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!isValid) {
			...
			htmlStringBuilder.append("<form action=\"CandidateSignupResumeServlet\" method=\"post\">");
			...
			String password = PasswordHasher.getInstance().generateHash(inputPassword1);
			...
			session.setAttribute("newIndustry", DatabaseController.getInstance().getIndustryId(industry));

			htmlStringBuilder = new StringBuilder(HtmlProvider.getInstance().getLoggedInHead("resume.css"));
			...
			htmlStringBuilder.append("<form method=\"post\" action=\"CandidateSignup2Servlet\" enctype=\"multipart/form-data\">");
      htmlStringBuilder.append("<br><input id=\"upload-button\" type=\"file\" name=\"uploadFile\" />"
      		+ "<br/><br/><input id=\"submit-button\" type=\"submit\" value=\"Upload\" /></form>");

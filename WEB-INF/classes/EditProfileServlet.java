...
public class EditProfileServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("candidateLoggedIn").equals("true")) {
			profileData = DatabaseController.getInstance().getCandidateProfileData((String) session.getAttribute("currentUser"));
			currentUserType = "candidate";
		} else if (session.getAttribute("organizationLoggedIn").equals("true")) {
			profileData = DatabaseController.getInstance().getOrganizationProfileData((String) session.getAttribute("currentUser"));
		...
		if (profileData == null) {
			...
			htmlStringBuilder = new StringBuilder(HtmlProvider.getInstance().getLoggedInHead("edit-profile.css"));
		    ...
		    htmlStringBuilder.append("<form class=\"form\" action=\"");
		    if (currentUserType.equals("candidate")) {
		    	htmlStringBuilder.append("CandidateProfileServlet");
		    } else {
		    	htmlStringBuilder.append("OrganizationProfileServlet");
		    }	
